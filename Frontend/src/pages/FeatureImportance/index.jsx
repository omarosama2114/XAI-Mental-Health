    ...
    <>
      ...
      <div className="flex flex-col h-screen bg-white-A700 justify-between p-5">
        ...
        <Text as="p" className="text-center text-base md:text-lg mx-2 my-4">
          <span className="text-gray-900">Dein </span>
          <span style={{ color: "#15b1e2", fontWeight: "bold" }}>Alter</span>
          <span className="text-gray-900"> und deine </span>
          <span style={{ color: "#15b1e2", fontWeight: "bold" }}>tägliche Schrittzahl</span>
          <span className="text-gray-900"> <br /> sind die wichtigsten Faktoren, die deine Prognose bestimmen.</span>
        </Text>
