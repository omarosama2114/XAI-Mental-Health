...
export default function B16Page() {
  ...
  return (
    <div className={styles.container}>
      ...
      <form>
        ...
        <div className={styles.question}>
          <h2 style={{fontSize: '16px', fontWeight:'bold', color: '#19b394'}} >Ich weiß, an wen oder an welche Stellen ich mich wenden müsste, wenn ich Präventionsangebote für meine mentale Gesundheit in Anspruch nehmen wollen würde</h2>
          <br />
          {['Ich stimme überhaupt nicht zu', 'Ich stimme eher nicht zu', 'Ich stimme weder zu noch lehne ich ab', 'Ich stimme eher zu', 'Ich stimme voll und ganz zu'].map(option => (
            <label key={option}>
              <input
        ...
        <div className={styles.question}>
          <h2 style={{fontSize: '16px', fontWeight:'bold', color: '#19b394'}} >Wenn ich präventive Maßnahmen zum Erhalt meiner mentalen Gesundheit ergreifen wollen würde, könnte ich professionelle Hilfe in Anspruch nehmen</h2>
          <br />
          {['Ich stimme überhaupt nicht zu', 'Ich stimme eher nicht zu', 'Ich stimme weder zu noch lehne ich ab', 'Ich stimme eher zu', 'Ich stimme voll und ganz zu'].map(option => (
            <label key={option}>
              <input
